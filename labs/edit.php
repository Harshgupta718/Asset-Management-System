...
<form action="<?php echo WEB_ROOT; ?>labs/processLab.php?action=edit" method="post" enctype="multipart/form-data" name="frmAddUser" id="frmAddUser">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  <tr align="center" id="listTableHeader"> 
   <td colspan="2">Edit Department</td>
   </tr>
  <tr> 
   <td width="150" class="label">Department Name </td>
   <td class="content">
 ...
 <p align="center"> 
  <input name="btnAddUser" type="button"   class="button" id="btnAddUser" value="Edit Department (+)" onClick="checkAddLabForm();" class="box">
...
?>
<p>Not Valid Department Selected.</p>
<?php
}
?>
</div>