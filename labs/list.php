...
<p>&nbsp;</p>
<h2 class="catHead">Department Management</h2>
<p><img src="images/labs.png" class="left"/>
<strong>This page allow an administrator to manage department in the system.</strong>
<br/>
...
?>
  ...
  <tr> 
   <td colspan="5" align="right"><input name="btnAddUser" type="button" id="btnAddUser" value="Add New Department"  class="button" onClick="addLab()"></td>
  </tr>
 </table>
 <p>&nbsp;</p>
</form>
